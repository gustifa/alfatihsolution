    ...
    <nav className="bg-blue-800 text-white shadow-lg sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <Link className="flex items-center space-x-3 md:space-x-4">
            {/* Render Logo Dinamis */}
            {dataPengaturan?.logo ? (
              <img
            ...
            <div>
              <h1 className="text-sm md:text-xl font-bold tracking-wide uppercase line-clamp-1">
                {namaSekolah}
              </h1>
              <p className="text-[10px] md:text-xs text-blue-200 line-clamp-1">
                {slogan}
              </p>
            </div>
          </Link>
          ...
          <div className="hidden md:flex space-x-8 text-sm font-medium items-center">
            ...
            <div className="relative group py-6">
              ...
              <div className="absolute top-16 left-0 w-56 bg-white rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 border border-gray-100 overflow-hidden">
                ...
                <a
                  href="/profil#sejarah"
                  className="block px-5 py-3 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700 font-semibold border-b border-gray-50"
                >
                  Sejarah Singkat
                </a>
                <a
                ...
                <a
                  ...
                  className="block px-5 py-3 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700 font-semibold"
                >
                  Struktur Organisasi
                </a>
              </div>
            ...
            <a href="/#jurusan" className="hover:text-yellow-400 transition">
              Program
            </a>
            <Link
              href="/kehadiran"
      ...
      {isMobileMenuOpen && (
        <motion.div
          ...
          className="md:hidden bg-blue-900 px-4 pt-2 pb-6 space-y-3 shadow-inner border-t border-blue-800"
        >
          <Link
            href="/"
            className="block px-3 py-2 rounded-md text-base font-medium hover:bg-blue-800 hover:text-yellow-400 transition"
          >
            Beranda
          </Link>
          <div className="pl-3 border-l-2 border-blue-700 space-y-1 my-2">
            <p className="text-xs text-blue-300 uppercase tracking-wider mb-2 font-bold ml-3 mt-2">
              Profil Sekolah
            </p>
            <a
              href="/profil#sejarah"
              onClick={() => setIsMobileMenuOpen(false)}
              className="block px-3 py-2 rounded-md text-sm font-medium hover:bg-blue-800 hover:text-yellow-400 transition"
            >
              › Sejarah Singkat
            </a>
            <a
          ...
          <a
            href="/admin"
            className="block mt-4 text-center bg-yellow-500 text-blue-900 px-5 py-3 rounded-full font-bold hover:bg-yellow-400 transition shadow-lg"
          >
            Login Portal
          </a>
        </motion.div>
